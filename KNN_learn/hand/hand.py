...
os.chdir(r'D:\tzh\MLproject\KNN_learn\hand\digits\training_digits')
...
def hand_writing_class_test(k):
    ...
    data_test, labels_test, file_len_test = load_percent(r'D:\tzh\MLproject\KNN_learn\hand\digits\test_digits', k)
    # 处理训练集数据
    ...
    data_train, labels_train, file_len_train = load_percent(r'D:\tzh\MLproject\KNN_learn\hand\digits\training_digits',
                                                            k)

    # 开始测试
    time_begin = time.time()  # 记录时间
...
if __name__ == '__main__':
    ...
    hand_writing_class_test(0.8)  # 调用测试函数
